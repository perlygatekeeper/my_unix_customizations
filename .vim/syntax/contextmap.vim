...
syn match contextMaps                   "\<\%(rules\|defaults\|context\|module\|page\|exact\|re_match\|refer_id\|conf\)\>"
syn match contextMapsConfs              "\<\%(cacheable_page_ttl\|omniture_uri_as_pagename\|chromeless\|omniture\|root\|continent\|mobile_avail\|path\|host\|enable_sbb\|uri\|query\)\>"
...
" ContextMaps highlighting
HiLink contextMaps              Keyword
HiLink contextMapsConfs         Label
